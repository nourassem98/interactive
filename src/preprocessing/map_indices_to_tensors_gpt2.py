...
#parser.add_argument('--save', type=str, default='./data/processed/wiki2016_gpt2/tensors_100000_min100/',
...
#parser.add_argument('--new_dict_file', type=str, default='./data/processed/wiki2016_gpt2/tensors_100000_min100/dict_idx_compact',
